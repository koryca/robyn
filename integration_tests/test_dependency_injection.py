...
def test_param_with_dependency(function_type: str, session):
...
@pytest.mark.benchmark
@pytest.mark.parametrize("function_type", ["sync", "async"])
def test_param_suffix_with_dependency(function_type: str, session):
...
@pytest.mark.benchmark
@pytest.mark.parametrize("function_type", ["sync", "async"])
def test_serve_html_with_dependency(function_type: str, session):
...
@pytest.mark.benchmark
@pytest.mark.parametrize("function_type", ["sync", "async"])
def test_template_with_dependency(function_type: str, session):
    def check_response(r: Response):
...
@pytest.mark.benchmark
@pytest.mark.parametrize("function_type", ["sync", "async"])
def test_queries_with_dependency(function_type: str, session):
